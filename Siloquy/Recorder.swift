...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.victorrodrigues.siloquy", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "com.victorrodrigues.siloquy.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "com.victorrodrigues.siloquy.audioSetup", qos: .userInitiated)
