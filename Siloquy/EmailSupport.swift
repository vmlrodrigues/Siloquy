...
struct EmailSupport {
    private static let supportEmailAddress = "support@jeunj.com"
    private static let supportEmailSubject = "Siloquy Support Request"
    ...
    static func generateSupportEmailBody() -> String {
        ...
        ## 📋 COMMON ISSUES:
        Check out our Common Issues page before sending an email: https://github.com/vmlrodrigues/Siloquy/issues
        ------------------------
