...
struct DictionaryQuickAddView: View {
    ...
    private var vocabularyInput: some View {
        HStack(spacing: 11) {
            ...
            TextField("", text: $wordInput, prompt: Text("e.g. Siloquy, MyTerm").foregroundColor(.secondary))
        ...
        VStack(spacing: 8) {
            ...
            HStack(spacing: 10) {
                Text("With")
                    ...
                    .foregroundStyle(.secondary)
                    .frame(width: 56, alignment: .trailing)
                TextField("", text: $replacementInput, prompt: Text("e.g. user@example.com").foregroundColor(.secondary))
                    .textFieldStyle(.roundedBorder)
                    .font(.system(size: 14))
