...
class HistoryWindowController: NSObject, NSWindowDelegate {
    ...
    private let windowIdentifier = NSUserInterfaceItemIdentifier("com.victorrodrigues.siloquy.historyWindow")
    private let windowAutosaveName = NSWindow.FrameAutosaveName("SiloquyHistoryWindowFrame")
    ...
    private func createHistoryWindow(modelContainer: ModelContainer, engine: VoiceInkEngine) -> NSWindow {
        ...
        window.title = "Siloquy — Transcription History"
