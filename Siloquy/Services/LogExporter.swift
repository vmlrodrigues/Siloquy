...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.victorrodrigues.siloquy", category: "LogExporter")
    private let subsystem = "com.victorrodrigues.siloquy"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== Siloquy Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "Siloquy_Logs_\(timestamp).log"
