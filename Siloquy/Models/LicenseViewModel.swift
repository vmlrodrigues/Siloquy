...
class LicenseViewModel: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.victorrodrigues.siloquy", category: "LicenseViewModel")
    ...
    func validateLicense() async {
        ...
        do {
            ...
            validationMessage = "An unexpected error occurred. Please try again or contact support at support@jeunj.com"
        }
