...
final class SoundPlaybackEngine: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.victorrodrigues.siloquy.soundPlayback", qos: .userInitiated)
    private let logger = Logger(subsystem: "com.victorrodrigues.siloquy", category: "SoundPlaybackEngine")
