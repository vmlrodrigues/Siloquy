...
struct VoiceInkApp: App {
    ...
    init() {
        ...
        let logger = Logger(subsystem: "com.victorrodrigues.siloquy", category: "Initialization")
        ...
        // Attempt 2: Try in-memory storage
            ...
            DispatchQueue.main.async {
                ...
                alert.informativeText = "Siloquy couldn't access its storage location. Your transcriptions will not be saved between sessions."
    ...
    private static func createPersistentContainer(schema: Schema, logger: Logger) -> ModelContainer? {
        do {
            ...
            #else
            let dictionaryCloudKit: ModelConfiguration.CloudKitDatabase = .private("iCloud.com.victorrodrigues.siloquy")
            #endif
        ...
        WindowGroup {
            if hasCompletedOnboarding {
                ContentView()
                    ...
                    .onAppear {
                        ...
                        if containerInitializationFailed {
                            ...
                            alert.informativeText = "Siloquy cannot initialize its storage system. The app cannot continue.\n\nPlease try reinstalling the app or contact support if the issue persists."
                ...
                OnboardingView(hasCompletedOnboarding: $hasCompletedOnboarding)
                    ...
                    .background(WindowAccessor { window in
                        if window.identifier == nil || window.identifier != NSUserInterfaceItemIdentifier("com.victorrodrigues.siloquy.onboardingWindow") {
